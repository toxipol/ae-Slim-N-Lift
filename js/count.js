function CountBox() {
		...
		if (amount < 0) {
			...
			out = "<div class='countbox-num'><div class='countbox-hours'>" + hours1 + hours2 + "</div><div class='countbox-hours-text'>часов</div></div>" +
			"<div class='countbox-space'></div>" +
			"<div class='countbox-num'><div class='countbox-mins'>" + mins1 + mins2 +"</div><div class='countbox-mins-text'>минут</div></div>" +
			"<div class='countbox-space'></div>" +
			"<div class='countbox-num'><div class='countbox-secs'><span></span>" + secs1 + secs2 +"</div><div class='countbox-secs-text'>секунд</div></div>";
			var list = document.getElementsByClassName("countbox");
			for (var i = 0; i < list.length; i++) {
				list[i].innerHTML = out;
			}
